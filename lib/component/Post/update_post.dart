...
class UpdatePost extends StatefulWidget {
  ...
  const UpdatePost({Key? key, required this.statepost,required this.postModel}) : super(key: key);

  @override
  State<UpdatePost> createState() => _CreatePostState();
}

class _CreatePostState extends State<UpdatePost> {
  List<XFile> _images = [];
  late bool statepost;
  ...
  void initState() {
    ...
    postController.textControllerContent.text=widget.postModel.contentPost;
  }
