...
class CreatePostGroup extends StatefulWidget {
  final bool statepost;
  final int idGroup;
  const CreatePostGroup({Key? key, required this.statepost, required this.idGroup}) : super(key: key);

  @override
  State<CreatePostGroup> createState() => _CreatePostState();
}

class _CreatePostState extends State<CreatePostGroup> {
  List<XFile> _images = [];
  late bool statepost;
                                ...
                                child: statecontent == true||_images!=null
                                    ? ElevatedButton(
                                        onPressed: () async {
                                          ...
                                          await _uploadImages();
                                          postController.createpostGroup(context,widget.idGroup);
                                        },
